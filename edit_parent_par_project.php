...
<?php   session_start();$get_id=$_SESSION['pid']; ?>
<?php
...
var street = document.parent.stname;
var city = document.parent.city;
var mobile  = document.parent.mno;
var land  = document.parent.lno;
...
<body>
    ...
    <div class="row-fluid">
        <div class="span12">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        <div class="hero-unit-3">
                            ...
                            <a href="parent_par_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
                            <br>
                            <br>
			...
			mysql_query("update parent set par_fname='$fn',par_lname='$ln',p_house_no='$no',p_street_name='$stname',
			p_city='$city',p_mobile_no='$mno',p_land_no='$lno',p_email_id='$email',p_location='$location' where parent_id='$get_id'
			")or die(mysql_error());

                               // header('location:parent_par_project.php');
                            }
                            ?>
                        </div>
