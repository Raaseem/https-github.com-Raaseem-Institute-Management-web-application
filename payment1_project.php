    ...
    <div class="container">
      <div class="row-fluid">
        <div class="span12">
		  ...
		  <a href="payment_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a> <br>
            <br>
            
            <form class="form-horizontal" method="POST" action="payment2_project.php">
