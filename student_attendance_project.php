                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
                            ...
                            <a href="attendance1_project.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Attendance</a>
                            <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysql_query("select * from student_attendance,student where student_attendance.stu_id=student.stu_id") or die(mysql_error());
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
                                            ...
                                            <a rel="tooltip"  title="Edit Attendance" id="e<?php echo $att_id; ?>" href="edit_student_attendance_project.php<?php echo '?id='.$att_id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
                                        </td>
                                    ...
                                    <div id="attendance_id<?php echo $att_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_student_attendance_project.php<?php echo '?id=' .$att_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                        </div>
                                    </div>
                                    <!-- end delete modal -->
