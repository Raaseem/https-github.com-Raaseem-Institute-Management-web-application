                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
                            ...
                            <a href="calculate_salary_project.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Pay Salary</a>
                            <br><br>
							
							<form id="frm_filter" name="frm_filter">
							<input type="checkbox" name="filtering" value="check" checked="checked">I need to filter Salary Data
							<br><br>
							
							<div class="control-group">
								<label class="control-label" for="inputEmail"></label>
								<div class="controls">Tutor Name
								   <select name="tut_fname#tut_lname" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_salary_project.php')" >
										<option></option>
										<?php
                                    ...
                                    &nbsp;&nbsp;Year
                                    <select name="year" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_salary_project.php')" >
									...
									&nbsp;&nbsp;From
									<select name="month#from" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_salary_project.php')">
										...
										&nbsp;&nbsp;To
										<select name="month#to" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_salary_project.php')">
										 <option select="selected"></option>
										<option>January</option>
										<option>February</option>
										<option>March</option>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Salary Table</strong>
                                </div>
