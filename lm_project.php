                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" method="post" action="view_mcq_project.php">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <button type="submit" name="save" class="btn btn-info"><i class="icon icon-large"></i>&nbsp;View Questions</button>
                                    </div>
                                </div>
