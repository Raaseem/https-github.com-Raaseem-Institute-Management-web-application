...
$sql3=mysql_query("select * from  tutor where tutor_id='$tutor_id'")or die(mysql_error());
$rows1=mysql_fetch_array($sql3);
$tut_fname = $rows1['tut_fname'];
$tut_lname = $rows1['tut_lname'];
$ans_name = $tut_fname . " " . $tut_lname;
...
// Insert answer 
$sql2= mysql_query("INSERT INTO $tbl_name(ques_id, batch_id,ans_name,ans_answer, ans_datetime)VALUES('$ques_id', '$batch_id', '$ans_name', '$ans_answer', '$datetime')") or die(mysql_error());
//$result2=mysql_query($sql2);

if($sql2){
echo "Successful<BR>";
echo "<a href='view_forum_tut_project.php?id=".$ques_id."'>View your answer</a>";
