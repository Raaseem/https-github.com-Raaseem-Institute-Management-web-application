    ...
    <div class="container">
      <div class="row-fluid">
        <div class="span12">
		  ...
		  <a href="tutor_home_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a> <br>
            <br>
            
            <form class="form-horizontal" method="POST" action="student_tut2_project.php">
