                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
							...
							<a href="forum_tut_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
						<br>
...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<form name="form1" method="post" action="add_forum_answer_tut_project.php">
<td>
...
<td><input name="tutor_id" type="hidden" id="tutor_id" value="<?php echo $gett_id?>"></td>
