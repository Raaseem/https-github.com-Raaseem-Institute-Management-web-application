                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
                            ...
                            <?php
								...
								$sql = mysql_query("SELECT * FROM student WHERE password = '$old'") or die (mysql_error());
								...
								if ($new == $con){
								$update = mysql_query("UPDATE student SET  password = '$new' WHERE password = '$old' ") or die (mysql_error());
