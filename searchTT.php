                        ...
                        <div class="hero-unit-3">
							...
							<div class="control-group">
								...
								<div class="controls">Lecture Hall Name
								   <select name="class_name" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option></option>
										<?php
									...
									&nbsp;&nbsp;Subject Name
									<select name="sub_name" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option></option>
										<?php
									...
									&nbsp;&nbsp;Grade
									<select name="grade" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
									...
									&nbsp;&nbsp;Batch ID
									<select name="batch_id" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option></option>
										<?php
							...
							<div class="control-group">
								...
								<div class="controls">Tutor Name
								   <select name="tut_fname#tut_lname" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option></option>
										<?php
									...
									<!-- &nbsp;&nbsp;Timeslot
									<select name="timeslot" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option selected="selected"></option>
									...
									&nbsp;&nbsp;Day
									<select name="day" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_project.php')" >
										<option selected="selected"></option>
