            ...
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="contact_project.php"><i class="icon-envelope-alt icon-large"></i>&nbsp;Contact Us
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div> 
                            </a>                
                        ...
                        <!--    <div class="alert alert-success">  Talisay Campus </div> -->
                           ...
                           <div class="row-fluid"> 
                                <div class="span6">
								  ...
								  <p><i class="icon-circle"></i>&nbsp;Address:<br>Mac Academy,<br>Main Road,<br>Thambala.</p>
                                  <p><i class="icon-circle"></i>&nbsp;Contact No:<br>Land: 0322260321 <br>Mobile: 0776655643</p>
								  <p><i class="icon-circle"></i>&nbsp;Email:<br>Macthambla@gmail.com</p>
								  <p><i class="icon-circle"></i>&nbsp;Facebook:<br>Mac Academy Thambala</p>
								  <p><i class="icon-circle"></i>&nbsp;Twitter:<br>Mac-Academy-Thambala</p>
