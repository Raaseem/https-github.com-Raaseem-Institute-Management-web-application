...
<body>
    ...
    <div class="row-fluid">
        <div class="span12">
                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" name='student' method="post" enctype="multipart/form-data" onSubmit="return formValidation();">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="stu_id" value="<?php echo $row['stu_id']; ?>" required>
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" id="inputEmail" name="dob" value="<?php echo $row['dob']; ?>" required>
                                    </div>
                                </div>
			...
			mysql_query("update student set stu_id='$stu_id',stu_fname='$fn',stu_lname='$ln',house_no='$no',street_name='$stname',
			city='$city',mobile_no='$mno',land_no='$lno',email_id='$email',dob='$dob',reg_date='$regdate',location='$location',parent_id='$par_id' where stu_id='$get_id'
			")or die(mysql_error());
