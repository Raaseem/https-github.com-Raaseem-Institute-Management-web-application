                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" name='admin' method="post" enctype="multipart/form-data" onSubmit="return formValidation();">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="no" value="<?php echo $row['a_house_no']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Street Name</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="stname" value="<?php echo $row['a_street_name']; ?>" required>
                                    </div>
                                </div>
								 <div class="control-group">
                                    <label class="control-label" for="inputEmail">City</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="city" value="<?php echo $row['a_city']; ?>" required>
                                    </div>
                                </div>
								 <div class="control-group">
                                    <label class="control-label" for="inputEmail">Mobile NO</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="mno" value="<?php echo $row['a_mobile_no']; ?>" >
                                    </div>
                                </div>
								 <div class="control-group">
                                    <label class="control-label" for="inputEmail">Land No</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="lno" value="<?php echo $row['a_land_no']; ?>" >
                                    </div>
                                </div>
								 <div class="control-group">
                                    <label class="control-label" for="inputEmail">Email ID</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="email" value="<?php echo $row['a_email_id']; ?>" required>
                                    </div>
                                </div>
                            ...
                            if (isset($_POST['save'])) {
                                ...
                                $updateQuery = mysql_query("update admin set admin_id='$admin_id',adm_fname='$fn',adm_lname='$ln',a_house_no='$no',a_street_name='$stname',
                                a_city='$city',a_mobile_no='$mno',a_land_no='$lno',a_email_id='$email',a_location='$location' where admin_id='$get_id'
                                ")or die(mysql_error());
                               ...
                               // header('location:admin_adm_project.php');
                            }
                            ?>
                        </div>
