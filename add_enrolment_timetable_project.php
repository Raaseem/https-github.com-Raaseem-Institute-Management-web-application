                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
							...
							<a href="add_enrolment_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
            
                            <br><br>
							
							<form id="frm_filter" name="frm_filter">
							<input type="checkbox" name="filtering" value="check" checked="checked">I need to filter Batch Details
							<br><br>
							
							<div class="control-group">
								<label class="control-label" for="inputEmail"></label>
								<div class="controls">Subject Name
								   <select name="sub_name" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_add_enrolment_project.php')" >
										<option></option>
										<?php
									...
									&nbsp;&nbsp;Grade
									<select name="grade" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_add_enrolment_project.php')" >
									...
									&nbsp;&nbsp;Tutor Name
									 <select name="tut_fname#tut_lname" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_add_enrolment_project.php')" >
										<option></option>
										<?php
                                    ...
                                    &nbsp;&nbsp;Day
									 <select name="day" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_add_enrolment_project.php')" >
										<option selected="selected"></option>
							...
							<!-- <div class="control-group">
								<label class="control-label" for="inputEmail"></label>
								<div class="controls">Timeslot
								   <select name="timeslot" class="span2" onchange="Ajax.init('frm_filter', 'http://localhost/elearning/filtering_timetable_add_enrolment_project.php')" >
										<option selected="selected"></option>
