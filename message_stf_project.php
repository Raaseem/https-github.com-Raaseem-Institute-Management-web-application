                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
							...
							<a href="sent_message_stf_project.php" class="btn btn-success"><i class="icon-book-sign icon-large"></i>&nbsp;Sent</a>
                            <a href="send_message_stf_project.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Send Message</a>							
                            <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysql_query("select * from message_staff where receiver_id='$get_id'") or die(mysql_error());
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
                                            ...
                                            <a rel="tooltip"  title="View Message" id="e<?php echo $mess_id; ?>" href="view_message_stf_project.php<?php echo '?id='.$mess_id; ?>" class="btn btn-success"><i class="icon-info-sign icon-large"></i></a>
                                        </td>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_message_stf_project.php<?php echo '?id=' . $mess_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                        </div>
                                    </div>
                                    <!-- end delete modal -->
