                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
                            <a href="staff_stf_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
                            <br><br>
                            ...
                            <?php
								...
								$sql = mysql_query("SELECT * FROM staff WHERE password = '$old'") or die (mysql_error());
								...
								if ($new == $con){
								$update = mysql_query("UPDATE staff SET  password = '$new' WHERE password = '$old' ") or die (mysql_error());
