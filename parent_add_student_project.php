                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
							...
							<a href="add_student_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
                            <a href="add_parent_add_student_project.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Parent</a>
                            <br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
											...
											<a rel="tooltip"  title="Select Parent ID" id="f<?php echo $parent_id; ?>" href="add_student_project.php<?php echo '?id='.$parent_id; ?>" class="btn btn-success"><i class="icon-ok icon-large"></i></a>
                                        </td>
