    ...
    <div class="container">
      <div class="row-fluid">
        <div class="span12">
		  ...
		  <a href="student_marks_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a> <br>
            <br>
            
            <form class="form-horizontal" method="POST" action="marks2_project.php">
