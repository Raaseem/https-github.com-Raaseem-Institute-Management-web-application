                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-3">
							...
							<a href="message_stu_project.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>						
                            <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Sent</strong>
                                </div>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysql_query("select * from message_student where sender_id='$get_id'") or die(mysql_error());
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
                                            ...
                                            <a rel="tooltip"  title="View Message" id="e<?php echo $mess_id; ?>" href="view_sent_message_stu_project.php<?php echo '?id='.$mess_id; ?>" class="btn btn-success"><i class="icon-info-sign icon-large"></i></a>
                                        </td>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_sent_message_stu_project.php<?php echo '?id=' . $mess_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                        </div>
                                    </div>
                                    <!-- end delete modal -->
